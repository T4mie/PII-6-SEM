 ...
 */var ly;function Zw(){if(ly)return Yo;ly=1;var n=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function i(o,l,c){var f=null;if(c!==void 0&&(f=""+c),l.key!==void 0&&(f=""+l.key),"key"in l){c={};for(var p in l)p!=="key"&&(c[p]=l[p])}else c=l;return l=c.ref,{$$typeof:n,type:o,key:f,ref:l!==void 0?l:null,props:c}}return Yo.Fragment=t,Yo.jsx=i,Yo.jsxs=i,Yo}var uy;function Qw(){return uy||(uy=1,ed.exports=Zw()),ed.exports}var K=Qw(),nd={exports:{}},pt={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sa=new zx("@firebase/app"),RC="@firebase/app-compat",OC="@firebase/analytics-compat",CC="@firebase/analytics",DC="@firebase/app-check-compat",kC="@firebase/app-check",MC="@firebase/auth",NC="@firebase/auth-compat",PC="@firebase/database",UC="@firebase/data-connect",LC="@firebase/database-compat",IC="@firebase/functions",BC="@firebase/functions-compat",zC="@firebase/installations",VC="@firebase/installations-compat",HC="@firebase/messaging",jC="@firebase/messaging-compat",qC="@firebase/performance",FC="@firebase/performance-compat",GC="@firebase/remote-config",YC="@firebase/remote-config-compat",XC="@firebase/storage",KC="@firebase/storage-compat",$C="@firebase/firestore",ZC="@firebase/ai",QC="@firebase/firestore-compat",WC="firebase",JC="12.4.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sh="[DEFAULT]",tD={[oh]:"fire-core",[RC]:"fire-core-compat",[CC]:"fire-analytics",[OC]:"fire-analytics-compat",[kC]:"fire-app-check",[DC]:"fire-app-check-compat",[MC]:"fire-auth",[NC]:"fire-auth-compat",[PC]:"fire-rtdb",[UC]:"fire-data-connect",[LC]:"fire-rtdb-compat",[IC]:"fire-fn",[BC]:"fire-fn-compat",[zC]:"fire-iid",[VC]:"fire-iid-compat",[HC]:"fire-fcm",[jC]:"fire-fcm-compat",[qC]:"fire-perf",[FC]:"fire-perf-compat",[GC]:"fire-rc",[YC]:"fire-rc-compat",[XC]:"fire-gcs",[KC]:"fire-gcs-compat",[$C]:"fire-fst",[QC]:"fire-fst-compat",[ZC]:"fire-vertex","fire-js":"fire-js",[WC]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class De{constructor(t,i){this.bucket=t,this.path_=i}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const t=encodeURIComponent;return"/b/"+t(this.bucket)+"/o/"+t(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(t,i){let o;try{o=De.makeFromUrl(t,i)}catch{return new De(t,"")}if(o.path==="")return o;throw ED(t)}static makeFromUrl(t,i){let o=null;const l="([A-Za-z0-9.\\-_]+)";function c(X){X.path.charAt(X.path.length-1)==="/"&&(X.path_=X.path_.slice(0,-1))}const f="(/(.*))?$",p=new RegExp("^gs://"+l+f,"i"),h={bucket:1,path:3};function m(X){X.path_=decodeURIComponent(X.path)}const g="v[A-Za-z0-9_]+",y=i.replace(/[.]/g,"\\."),x="(/([^?#]*).*)?$",w=new RegExp(`^https?://${y}/${g}/b/${l}/o${x}`,"i"),S={bucket:1,path:3},_=i===Yx?"(?:storage.googleapis.com|storage.cloud.google.com)":i,R="([^?#]*)",C=new RegExp(`^https?://${_}/${l}/${R}`,"i"),I=[{regex:p,indices:h,postModify:c},{regex:w,indices:S,postModify:m},{regex:C,indices:{bucket:1,path:2},postModify:m}];for(let X=0;X<I.length;X++){const z=I[X],J=z.regex.exec(t);if(J){const $=J[z.indices.bucket];let G=J[z.indices.path];G||(G=""),o=new De($,G),z.postModify(o);break}}if(o==null)throw wD(t);return o}}class DD{constructor(t){this.promise_=Promise.reject(t)}getPromise(){return this.promise_}cancel(t=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jD(){return typeof BlobBuilder<"u"?BlobBuilder:typeof WebKitBlobBuilder<"u"?WebKitBlobBuilder:void 0}function qD(...n){const t=jD();if(t!==void 0){const i=new t;for(let o=0;o<n.length;o++)i.append(n[o]);return i.getBlob()}else{if(sp())return new Blob(n);throw new Gt(Ft.UNSUPPORTED_ENVIRONMENT,"This browser doesn't seem to support creating Blobs")}}function FD(n,t,i){return n.webkitSlice?n.webkitSlice(t,i):n.mozSlice?n.mozSlice(t,i):n.slice?n.slice(t,i):null}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function GD(n){if(typeof atob>"u")throw OD("base-64");return atob(n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Va{constructor(t,i){let o=0,l="";tb(t)?(this.data_=t,o=t.size,l=t.type):t instanceof ArrayBuffer?(i?this.data_=new Uint8Array(t):(this.data_=new Uint8Array(t.byteLength),this.data_.set(new Uint8Array(t))),o=this.data_.length):t instanceof Uint8Array&&(i?this.data_=t:(this.data_=new Uint8Array(t.length),this.data_.set(t)),o=t.length),this.size_=o,this.type_=l}size(){return this.size_}type(){return this.type_}slice(t,i){if(tb(this.data_)){const o=this.data_,l=FD(o,t,i);return l===null?null:new Va(l)}else{const o=new Uint8Array(this.data_.buffer,t,i-t);return new Va(o,!0)}}static getBlob(...t){if(sp()){const i=t.map(o=>o instanceof Va?o.data_:o);return new Va(qD.apply(null,i))}else{const i=t.map(f=>op(f)?YD(Dn.RAW,f).data:f.data_);let o=0;i.forEach(f=>{o+=f.byteLength});const l=new Uint8Array(o);let c=0;return i.forEach(f=>{for(let p=0;p<f.length;p++)l[c++]=f[p]}),new Va(l,!0)}}uploadData(){return this.data_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function CT(n,t,i=!1){if(gn(n.app))return Promise.reject(Ka(n));const o="signIn",l=await OT(n,o,t),c=await Ir._fromIdTokenResponse(n,o,l);return i||await n._updateCurrentUser(c.user),c}async function OM(n,t){return CT(Gr(n),t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function B3(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function z3(n){Lr(new Oi("auth",(t,{options:i})=>{const o=t.getProvider("app").getImmediate(),l=t.getProvider("heartbeat"),c=t.getProvider("app-check-internal"),{apiKey:f,authDomain:p}=o.options;ut(f&&!f.includes(":"),"invalid-api-key",{appName:o.name});const h={apiKey:f,authDomain:p,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:wT(n)},m=new rM(o,l,c,h);return mM(m,i),m},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((t,i,o)=>{t.getProvider("auth-internal").initialize()})),Lr(new Oi("auth-internal",t=>{const i=Gr(t.getProvider("auth").getImmediate());return(o=>new I3(o))(i)},"PRIVATE").setInstantiationMode("EXPLICIT")),Xa(wb,Eb,B3(n)),Xa(wb,Eb,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
